---
title: 吴恩达老师深度学习公开课学习笔记目录
date: 2020-09-27 15:50:23
categories: 
- 学习笔记
tags:
- 深度学习
---
吴恩达老师深度学习公开课学习笔记目录（记录一些自己认为重要的内容，方便自己以后查看）
<!-- more -->
# 深度学习笔记目录

## 第一门课 神经网络和深度学习(Neural Networks and Deep Learning)
{% post_link AndrewNg-deepinglearning-ai-note-NeuralNetworksandDeepLearning-IntroductiontoDeepLearning-1 第一周：深度学习引言(Introduction to Deep Learning) %}
...
{% post_link AndrewNg-deepinglearning-ai-note-NeuralNetworksandDeepLearning-BasicsofNeuralNetworkProgramming 第二周：神经网络的编程基础(Basics of Neural Network programming)  %}
...
{% post_link AndrewNg-deepinglearning-ai-note-NeuralNetworksandDeepLearning-ShallowNeuralNetworks 第三周：浅层神经网络(Shallow neural networks)  %}
